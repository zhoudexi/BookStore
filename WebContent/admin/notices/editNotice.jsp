...
<body>
	...
	<form
		action="${pageContext.request.contextPath }/NoticeEditServlet?id=${notice.n_id}&method=editById"
		method="post">
		<table border="1"
			...
			<tr height="40px">
				...
				<td colspan="3"><textarea rows="7" cols="120" name="details">${ notice.details }</textarea></td>
			</tr>
			<tr height="40px">
